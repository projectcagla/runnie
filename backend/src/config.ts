...
export const BACKEND_CONFIG = {
  ...
  DB_PATH: process.env.DB_PATH || path.join(process.cwd(), 'data', 'runapp.sqlite'),
  
  // Kimlik Doğrulama
  AUTH_SECRET: process.env.AUTH_SECRET || 'runapp-dev-device-secret-key-32chars!!',
  TOKEN_TTL_DAYS: 365,
